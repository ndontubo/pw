...
def blackjack(player_list, player_dict):
	...
	for n in range(len(new_player_list)):
		...
		print('ALL OTHER PLAYERS LEAVE THIS SCREEN, YOU WILL BE CALLED ONCE CURRENT PLAYER IS DONE HIS/HER ROUND')
...
def main():
	...
	if quest1 in yes_list:
		...
		if player_count > 0:
			...
			os.system('clear')
			print(msg4)
			blackjack(player_list, player_dict)
		else:
			time.sleep(2)
			print('NICE TRY\n')
			time.sleep(1)
