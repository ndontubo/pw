...
def add():
    ...
    extra = input('Do you want find sum even or odd: "Y or N"  ')
    if extra == 'Y':
        eveOdd(num)
    else:
        print('Thank you')
...
def febo():
    ...
    pyrmid = input("Do you also want pyramid : Y or N")
    a = 0
    b = 1
    febList = [a,b]
...
def main():
  febonacilist = febo()
  print(febonacilist)
  urname = input('Enter you name please :  ')
  print ('########################################')
  print ("Hello" + ' ' + urname + ' Thank you for using this program')
  print ('########################################')
  inc = input('Do you want add two numbers "Y or N"  : ')
  if (inc == 'Y') :
    while (inc == 'Y' ) :
      add()
      inc = input('Do you want to continue add two numbers "Y or N" : ')
      if (inc == 'N') :
